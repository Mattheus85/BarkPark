...
(function scopeWrapper($) {
    ...
    BarkPark.authToken = new Promise(function fetchCurrentAuthToken(resolve, reject) {
    ...
    function handleSignin(event) {
        ...
        signin(username, password,
            function signinSuccess() {
                ...
                var cognitoUser = userPool.getCurrentUser();
                // axios
                //     .post(`https://hdvd9zw9q5.execute-api.us-west-1.amazonaws.com/cognitotest/users?username=${username}`)
                //     .then((userPostResult) => {
                ...
                //         console.log(error);
                //     });
                window.location.href = 'cognito.html';
            },
